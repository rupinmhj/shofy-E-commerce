...
const DFS = () => {
  return (
    <div className='overflow-hidden max-md:gap-5 lg:mx-32 grid xl:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 mt-5 gap-5 max-lg:w-[90%] max-lg:mx-8 '>
      
        <div className='   overflow-hidden '>
            <p className='px-6  w-[450px] text-[24px] font-roboto font-bold mb-10  text-textBlack'>Discount products</p>
        {productsOne.map((product) => (
              <a
                key={product.id}
                href={product.href}
                className=" flex  justify-start h-38 bg-white px-4 py-2 mx-2 border-b w-[420px] last:border-none group "
              >
                <img
                  src={product.imageSrc}
                  className=" bg-bgGray aspect-square h-36 w-36  rounded-lg object-cover  transition-transform duration-200 transform group-hover:scale-105 cursor-pointer hover:opacity-75 xl:aspect-7/8"
                />
        ...
        <div className='  overflow-hidden '>
        <p className='px-6  w-[450px] text-[24px] font-roboto font-bold mb-10 text-textBlack'>Featured products</p>
        {productsTwo.map((product) => (
              <a
              key={product.id}
              href={product.href}
              className=" flex  justify-start h-38 bg-white px-4 py-2 border-b w-[420px] last:border-none group "
            >
              <img
                src={product.imageSrc}
                className=" bg-bgGray aspect-square h-36 w-36  rounded-lg object-cover  transition-transform duration-200 transform group-hover:scale-105 cursor-pointer hover:opacity-75 xl:aspect-7/8"
        ...
        <div className='  overflow-hidden '>
        <p className='px-6  w-[450px] text-[24px] font-roboto font-bold mb-10 text-textBlack'>Selling Products</p>
